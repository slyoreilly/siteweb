...
menus[2].liensContexte=new Array();
menus[2].liensContexte[1]=0;
menus[2].liensContexte[2]=3;
menus[2].liensContexte[3]=4;
menus[2].liensContexte[4]=6;
menus[2].liensContexte[5]=7;
...
menus[6].type="n2";
menus[6].innerHTML="Horaire";
menus[6].iH_fr="Horaire";
menus[6].iH_en="Schedule";
menus[6].keyValue=new Array();menus[6].keyValue[0]={};
menus[6].keyValue[0].ligueId=null;
menus[6].ingredients=new Array();
menus[6].ingredients[0]="m";
menus[6].ingredients[1]="ligueId";
...
menus[7].ingredients=new Array();
menus[7].ingredients[0]="ligueId";
menus[7].ingredients[1]="userId";
...
menus[9].liensContexte[1]=0;
menus[9].liensContexte[2]=3;
menus[9].liensContexte[3]=4;
menus[9].liensContexte[4]=6;
menus[9].liensContexte[5]=7;
...
menus[11].liensContexte=new Array();
menus[11].liensContexte[1]=0;
menus[11].liensContexte[2]=3;
menus[11].liensContexte[3]=4;
menus[11].liensContexte[4]=6;
menus[11].liensContexte[5]=7;
...
menus[12].liensContexte[1]=0;
menus[12].liensContexte[2]=3;
menus[12].liensContexte[3]=4;
menus[12].liensContexte[4]=6;
menus[12].liensContexte[5]=7;
...
menus[22].liensContexte=new Array();

menus[22].liensContexte[1]=0;
menus[22].liensContexte[2]=3;
menus[22].liensContexte[3]=4;
menus[22].liensContexte[4]=6;
menus[22].liensContexte[5]=7;
...
menus[23].ingredients=new Array();
menus[23].ingredients[0]="m";
...
menus[24].ingredients=new Array();
menus[24].ingredients[0]="m";
menus[24].ingredients[1]="ligueId";
...
menus[26].liensContexte[1]=0;
menus[26].liensContexte[2]=3;
menus[26].liensContexte[3]=4;
menus[26].liensContexte[4]=6;
menus[26].liensContexte[5]=7;
...
menus[31]={};
menus[31].id="1_3_1";
menus[31].lien="/products/syncstats.html";
menus[31].type="n2";
menus[31].iH_fr="L'App Hockey";
menus[31].iH_en="The Hockey App";
menus[31].keyValue=new Array();menus[31].keyValue[0]={};
menus[31].keyValue[0].userId=null;
menus[31].ingredients=new Array();

menus[32]={};
menus[32].id="1_3_2";
menus[32].lien="/products/website.html";
menus[32].type="n2";
menus[32].iH_fr="Site Web";
menus[32].iH_en="Web Site";
menus[32].keyValue=new Array();menus[32].keyValue[0]={};
menus[32].keyValue[0].userId=null;
menus[32].ingredients=new Array();

menus[33]={};
menus[33].id="1_3_3";
menus[33].lien="/products/synccam.html";
menus[33].type="n2";
menus[33].iH_fr="SyncCam";
menus[33].iH_en="SyncCam";
menus[33].keyValue=new Array();menus[33].keyValue[0]={};
menus[33].keyValue[0].userId=null;
menus[33].ingredients=new Array();

menus[34]={};
menus[34].id="1_3_4";
menus[34].lien="/products/syncboard.html";
menus[34].type="n2";
menus[34].iH_fr="SyncBoard";
menus[34].iH_en="SyncBoard";
menus[34].keyValue=new Array();menus[34].keyValue[0]={};
menus[34].keyValue[0].userId=null;
menus[34].ingredients=new Array();

menus[35]={};
menus[35].id="1_1_3";
menus[35].lien="/zadmin/messages.html";
menus[35].type="n2";
menus[35].iH_fr="Messages";
menus[35].iH_en="Messages";
menus[35].keyValue=new Array();menus[35].keyValue[0]={};
menus[35].keyValue[0].ligueId=null;
...
hierarchie[2][1] =31; //"1_4";
hierarchie[2][2] =32; //"1_4";
hierarchie[2][3] =33; //"1_4";
hierarchie[2][4] =34; //"1_4";
...
motif[0][0] = "Non-défini";
motif[0][1] = "Undefined";
motif[1][0] = "Accrocher";
motif[1][1] = "Hooking";
motif[2][0] = "Cingler";
motif[2][1] = "Slashing";
motif[3][0] = "Conduite anti-sportive";
motif[3][1] = "Unsportmanship misconduct";
motif[4][0] = "Donner de la bande";
motif[4][1] = "Boarding";
motif[5][0] = "Obstruction";
motif[5][1] = "Interference";
motif[6][0] = "Retarder le match";
motif[6][1] = "Delay of the game";
motif[7][0] = "Avoir retenu";
motif[7][1] = "Holding";
motif[8][0] = "Rudesse";
motif[8][1] = "Roughing";
motif[9][0] = "S'être battû";
motif[9][1] = "Fighting";
motif[10][0] = "Trébucher";
motif[10][1] = "Tripping";
motif[11][0] = "Assaut";
motif[11][1] = "Assault";
motif[12][0] = "Bâton élevé";
motif[12][1] = "High-sticking";
motif[13][0] = "Coup de coude";
motif[13][1] = "Elbowing";
motif[14][0] = "Cracher";
motif[14][1] = "Spitting";
motif[15][0] = "Darder";
motif[15][1] = "Spearing";
motif[16][0] = "Coup de genou";
motif[16][1] = "Kneeing";
motif[17][0] = "Double échec";
motif[17][1] = "Cross-checking";
motif[18][0] = "Instigateur";
motif[18][1] = "Start a fight";
motif[19][0] = "Mise en échec";
motif[19][1] = "Body checking";
motif[20][0] = "Pousser un joueur";
motif[20][1] = "Pushing";
motif[22][0] = "Tentative de blessure";
motif[22][1] = "Hurting attempt";
motif[23][0] = "Alignement en retard";
motif[23][1] = "Delay rosters";
motif[24][0] = "Balle extérieure";
motif[24][1] = "Ball outside";
motif[25][0] = "Bâton brisé";
motif[25][1] = "Broken stick";
motif[26][0] = "Bâton haut sans contact";
motif[26][1] = "Non-contact high-stick";
motif[27][0] = "Changement illégal";
motif[27][1] = "Illegal changes";
motif[28][0] = "Chute Obstrusive";
motif[28][1] = "Interference fall";
motif[29][0] = "Geler la ball";
motif[29][1] = "Ball freezing";
motif[30][0] = "Lancer le bâton";
motif[30][1] = "Throw stick";
motif[32][0] = "Quitter banc des punitions";
motif[32][1] = "Leave penalty box";
motif[33][0] = "Pénalité majeure";
motif[33][1] = "Major Penalty";
motif[37][0] = "Inconduite de partie";
motif[37][1] = "Game misconduct";
