...
$rEvent = mysql_query("SELECT * FROM TableJoueur where (equipe_id_ref IS NULL OR equipe_id_ref=0) and Ligue=16")
or die(mysql_error());  
...
VALUES ('{$Event['joueur_id']}', 3, 30, '2012-09-02','2050-01-01')");	
		
	
	mysql_query("UPDATE TableJoueur SET dernierMAJ=NOW(), Ligue=NULL, equipe_id_ref=NULL WHERE joueur_id='{$Event['joueur_id']}' ");
