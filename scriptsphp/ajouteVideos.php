...
$systemLeagueId = isset($_POST['systemLeagueId']) ? intval($_POST['systemLeagueId']) : 0;
...
$qIns = "INSERT INTO DemandeAjoutVideo (
            eventId, typeEvenement, chronoDemande, cameraId, progression, systemLeagueId, dateCreation
        ) VALUES (
            '{$butId}', '{$eventTypeCode}', '{$chronoDemande}', '{$cameraId}', 1, " . ($systemLeagueId > 0 ? "'{$systemLeagueId}'" : "NULL") . ", NOW()
        )";
