...
//	requete_ajax.open('GET','stats/listeLigues2JSON.php?'+LigueID,false);
	requete_ajax.open('GET','/stats/Ligues2JSON.php?equipeId='+equipeId,false);
	requete_ajax.send(null);
//	alert(requete_ajax.responseText);
	return requete_ajax.responseText;
	}
...
//	alert(requete_ajax.responseText);
	...
	{
	var requete_ajax = new XMLHttpRequest();
	requete_ajax.open('GET','/stats/equipe2JSON.php?equipeId='+equipeId,false);
	requete_ajax.send(null);
//	alert(requete_ajax.responseText);
	return requete_ajax.responseText;
	}
	...
	{
	var requete_ajax = new XMLHttpRequest();
	requete_ajax.open('GET','/stats/joueursDansLigue2JSON.php?ligueId='+ligueId,false);
	requete_ajax.send(null);
//	alert(requete_ajax.responseText);
	return requete_ajax.responseText;
	}
	...
	{
	var requete_ajax = new XMLHttpRequest();
	requete_ajax.open('GET','/stats/gardiens2JSON.php?ligueId='+ligueId+'&saisonId='+saisonId+'&equipeId='+equipeId,false);
	requete_ajax.send(null);
//	alert(requete_ajax.responseText);
	return requete_ajax.responseText;
	}
